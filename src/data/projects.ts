...
const _projectsRaw: ProjectData[] = [
  ...
  },
  {
    ...
    tldr: "The new template library gave the People team a solid starting point, but there was still an opportunity to help people feel more confident about their visual choices. To bridge this gap, I designed and ran two internal masterclasses focused on impactful presentations and data visualization. The sessions equipped over 120 non-designers with practical rules of thumb, reducing basic formatting questions and shifting our day-to-day conversations toward narrative and structure.",
