...
export const projects: ProjectData[] = [
  {
    ...
    bigNumbers: [
      { value: '5', label: 'Leadership cohorts', description: 'Programs delivered across senior leadership tracks.' },
      { value: '+40%', label: 'Engagement increase', description: 'Measured uplift in participant engagement scores.' },
