...
const Hero = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background pt-28 pb-8">
      <div className="container mx-auto px-6 relative z-10">
        {/* Hero Card Container */}
        <motion.div className="bg-cream rounded-[2.5rem] p-8 md:p-12 lg:p-16" initial={{
        opacity: 0,
        scale: 0.95
      }} animate={{
        opacity: 1,
        ...
        ease: 'easeOut'
          ...
          <div className="text-left">
            {/* Hi there Badge */}
            <motion.div variants={badgeVariants} initial="hidden" animate="visible" className="inline-block mb-6">
            ...
            <motion.div className="mb-8" variants={headlineVariants} initial="hidden" animate="visible">
              ...
              <div className="flex items-center gap-3 flex-wrap mb-3">
                <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-medium text-[#919cb1]">
                  I'm
                </h1>
                ...
                <div className="relative inline-block" onMouseEnter={() => setIsPhotoHovered(true)} onMouseLeave={() => setIsPhotoHovered(false)}>
                  ...
                  ease: [0.4, 0, 0.2, 1]
                    ...
                    <Link to="/about" className="block w-full h-full">
                      ...
                      <AnimatePresence>
                        {isPhotoHovered && <motion.div initial={{
                        opacity: 0
                      }} animate={{
                        opacity: 1
                      }} exit={{
            ...
            <motion.p className="text-sm sm:text-base md:text-lg leading-relaxed max-w-2xl mb-10 font-normal text-stone-500" variants={descriptionVariants} initial="hidden" animate="visible">
              {t.hero.description}
            </motion.p>

            {/* CTA Buttons */}
            <motion.div className="flex flex-col sm:flex-row gap-4" variants={ctaVariants} initial="hidden" animate="visible">
              <a href="#work" className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-primary text-primary-foreground btn-filled-dark rounded-full hover:bg-dark-accent transition-all duration-300 hover:-translate-y-1">
                {t.hero.cta}
                <motion.span animate={{
                y: [0, 4, 0]
              }} transition={{
